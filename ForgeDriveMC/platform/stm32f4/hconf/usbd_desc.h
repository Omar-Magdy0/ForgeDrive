...
#ifndef __USBD_DESC_XCH_H
#define __USBD_DESC_XCH_H
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
extern USBD_DescriptorsTypeDef XCH_Desc; /* Replace 'XXX_Desc' with your active USB device class, ex: HID_Desc */

#endif /* __USBD_DESC_XCH_H*/
