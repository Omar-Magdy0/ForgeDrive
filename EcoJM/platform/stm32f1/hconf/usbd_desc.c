...
#define USBD_PRODUCT_HS_STRING        "EcoJM" 
#define USBD_PRODUCT_FS_STRING        "EcoJM" 
#define USBD_CONFIGURATION_HS_STRING  "Default Configuration" 
#define USBD_INTERFACE_HS_STRING      "Joulemeter" 
#define USBD_CONFIGURATION_FS_STRING  "Default Configuration" 
#define USBD_INTERFACE_FS_STRING      "Joulemeter" 
...
/* Private variables ---------------------------------------------------------*/
USBD_DescriptorsTypeDef XCH_Desc =
{
